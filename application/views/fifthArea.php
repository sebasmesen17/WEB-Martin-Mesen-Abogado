...
<head>
    ...
    <title>Derecho de la competencia y proteccion al consumidor</title>
    ...
    <section class="main">
        <section class="main__information">
            <div class="main__headline">
                <h3 class="main__title">DERECHO DE LA COMPETENCIA Y PROTECCION AL CONSUMIDOR</h3>
            </div>

            <div class="container">
                <div class="container__description">
                    <ul class="container__list">
                        <li class="container__item">Arbitraje nacional </li>
                        <li class="container__item">Litigios</li>
                        <li class="container__item">Mediación</li>
                        <li class="container__item">Negociación y conciliación</li>
                        <li class="container__item">Procesos administrativos</li>
                        <li class="container__item">Responsabilidad civil</li>
                        <li class="container__item">Representación en litigios relacionados con el derecho de la competencia</li>
                    </ul>
                </div>  
            </div>
        </section>
