...
<head>
    ...
    <title>Derecho financiero, bancario y bursatil</title>
    ...
    <section class="main">
        <section class="main__information">
            <div class="main__headline">
                <h3 class="main__title">DERECHO FINANCIERO</h3>
            </div>

            <div class="container">
                <div class="container__description">
                    <ul class="container__list">
                        <li class="container__item">Contratación bancaria especial </li>
                        <li class="container__item">Derivados financieros</li>
                        <li class="container__item">Emisión de obligaciones</li>
                        <li class="container__item">Estructuración de negocios</li>
                    </ul>
                </div>  
            </div>
        </section>
