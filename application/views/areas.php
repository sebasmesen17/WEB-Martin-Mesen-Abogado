...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js" integrity="sha384-OgVRvuATP1z7JjHLkuOU7Xw704+h835Lr+6QL9UvYjZE3Ipu6Tp75j7Bh/kR0JKI" crossorigin="anonymous"></script>
    <link rel="stylesheet" href="<?php echo base_url('css/stylesAreas.css'); ?>">
</head>
<body>
    <header class="header">
    ...
    <section class="main">
        ...
        <section class="main__areas">
            
            <div class="main__headline">
                <h3 class="main__title">ÁREAS DE TRABAJO</h3>
            </div>
            ...
            <div class="container">
                ...
                <div class="container__areas">
                    ...
                    <div class="area">
                        ...
                        <div class="areaimage">
                            <img class="areaimage__img" src="<?php echo base_url('img/areas/photo1.jpg'); ?>" alt="Derecho penal">
                        </div>
                        <div class="areatitle">
                            <a class="areatitle__link" href="<?php echo base_url() ?>index.php/FirstArea">DERECHO PENAL</a>
                        </div>
                    </div>
                    ...
                    <div class="area">
                        ...
                        <div class="areaimage">
                            <img class="areaimage__img" src="<?php echo base_url('img/areas/photo2.jpg'); ?>" alt="Derecho penal">
                        </div>
                        <div class="areatitle">
                            <a class="areatitle__link" href="<?php echo base_url() ?>index.php/SecondArea">DERECHO NOTARIAL Y REGISTRAL</a>
                        </div>
                    </div>
                    ...
                    <div class="area">
                        ...
                        <div class="areaimage">
                            <img class="areaimage__img" src="<?php echo base_url('img/areas/photo3.jpg'); ?>" alt="Derecho penal">
                        </div>
                        <div class="areatitle">
                            <a class="areatitle__link" href="<?php echo base_url() ?>index.php/ThirdArea">CRIMINOLOGÍA</a>
                        </div>
                    </div>
                    ...
                    <div class="area">
                        ...
                        <div class="areaimage">
                            <img class="areaimage__img" src="<?php echo base_url('img/areas/photo4.jpg'); ?>" alt="Derecho penal">
                        </div>
                        <div class="areatitle">
                            <a class="areatitle__link" href="<?php echo base_url() ?>index.php/FourthArea">DERECHO FINANCIERO, BANCARIO Y BÚRSATIL</a>
                        </div>
                    </div>
                    ...
                    <div class="area">
                        ...
                        <div class="areaimage">
                            <img class="areaimage__img" src="<?php echo base_url('img/areas/photo5.jpg'); ?>" alt="Derecho penal">
                        </div>
                        <div class="areatitle">
                            <a class="areatitle__link" href="<?php echo base_url() ?>index.php/FifthArea">DERECHO DE LA COMPETENCIA Y PROTECCION AL CONSUMIDOR</a>
                        </div>
                    </div>
                    ...
                    <div class="area">
                        ...
                        <div class="areaimage">
                            <img class="areaimage__img" src="<?php echo base_url('img/areas/photo6.jpg'); ?>" alt="Derecho penal">
                        </div>
                        <div class="areatitle">
                            <a class="areatitle__link" href="<?php echo base_url() ?>index.php/SixthArea">SEGUROS</a>
                        </div>
                    </div>
