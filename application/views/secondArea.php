...
<head>
    ...
    <title>Derecho notarial y registral</title>
    ...
    <section class="main">
        <section class="main__information">
            <div class="main__headline">
                <h3 class="main__title">DERECHO NOTARIAL Y REGISTRAL</h3>
            </div>

            <div class="container">
                <div class="container__description">
                    <ul class="container__list">
                        <li class="container__item">Trámites registrales como traspasos de bienes muebles e inmuebles, catastro, registro de
                        marcas de ganado, etc.</li>
                        <li class="container__item">Matrimonios, divorcios, procesos sucesorios.</li>
                        <li class="container__item">Constitución de sociedades, registro de accionistas y beneficiarios finales, disolución de
                        sociedades, etc.</li>
                    </ul>
                </div>  
            </div>
